...
def get_ncaa_players():
    return {"coming_soon": True, "players": [], "total": 0, "message": "NCAA data pipeline coming in v3.2"}


@app.get("/api/euroleague/players")
def get_euroleague_players():
    return {"coming_soon": True, "players": [], "total": 0, "message": "EuroLeague data pipeline coming in v3.2"}
