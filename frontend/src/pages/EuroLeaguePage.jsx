...
/* ── EuroLeague detail panel ─────────────────────────────────────── */
function EuroDetailPanel({ selected, detail, tab, setTab }) {
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              ...
              <span className="text-[9px] px-1.5 py-0.5 rounded font-medium"
                style={{ background: "rgba(255,105,0,.15)", color: EUR, border: "1px solid rgba(255,105,0,.3)" }}>
                EUR
              </span>
            </div>
          </div>
...
export default function EuroLeaguePage() {
  ...
  return (
    ...
    <SplitPane
      detail={selected ? (
        <EuroDetailPanel selected={selected} detail={detail} tab={tab} setTab={setTab} />
      ) : null}
